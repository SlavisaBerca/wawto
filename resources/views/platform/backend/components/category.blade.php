                                                ...
                                                <table class="table align-middle table-nowrap" id="customerTable">
                                                    <thead class="table-light">
                                                        <tr>
                                                            ...
                                                            <th class="sort" data-sort="phone">Subcategorii</th>
                                                            <th class="sort" data-sort="date">Domenii</th>
                                                            <th class="sort" data-sort="status">Vizibilitate</th>
                                                            <th class="sort" data-sort="action">Actiuni</th>
                                                            </tr>
                                                    </thead>
                                                    <tbody class="list form-check-all">
                                                        @foreach($categories as $category)
                                                        <?php if($category->show_rules===1){$visibility='Vizibil Pentru Furnizori';}elseif($category->show_rules===2){$visibility='Vizibil pentru utilizatori';}else{$visibility='Vizibil pentru toata lumea';}?>
                                                        <tr class="row1" data-id="{{ $category->id }}">
                                                            
                                                            
                                                            <td class="customer_name"><i class="fa fa-sort-amount-up"></i> {{$category->position}}</td>
                                                            <td class="email">{{$category->cat_title}}</td>
                                                            <td class="phone">{{$category->subcategory->count()}}</td>
                                                            <td class="phone">{{$category->domain->count()}}</td>
                                                            <td class="status"><span class="badge badge-soft-success text-uppercase">{{$visibility}}</span></td>
                                                            <td>
                                                                <div class="d-flex gap-2">
                                                                    <div class="edit">
																	 ...
																	 <div class="remove">
                                                                        <a class="btn btn-sm btn-warning remove-item-btn" href="{{route('sort-subcategories',$category->id)}}"><i class="fa fa-trash"></i> Organizare Subcategorii</a>
                                                                    </div>
                                                                    <div class="remove">
                                                                        <a class="btn btn-sm btn-danger remove-item-btn" href="{{route('delete-category',$category->id)}}"><i class="fa fa-trash"></i> Sterge</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                ...
                                <form action="{{route('edit-category',$category->id)}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="customername-field" value="{{$category->cat_title}}" name="cat_title" class="form-control" placeholder="Denumire" required />
                                        </div>
                                        <div class="mb-3">
                                            <label for="customername-field" class="form-label">Poza(Portret)</label>
                                            <input type="file" id="customername-field" name="cat_image" class="form-control" />
                                        </div>
                                        <div class="mb-3">
                                            <img src = "{{URL::to('platform/frontend/assets/images/categories/'.$category->cat_image)}}" style="height:150px;width:100px;">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label for="">Vizibilitate</label>
                                            <select name="position" id="position" class="form-control">
                                                <option value="0"selected>Toata Lumea</option>
                                                <option value="1">Doar Furnizori</option>
                                                <option value="2">Toti Utilizatori</option>
                                            </select>
                                        </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="{{route('add-category')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                <label for="customername-field" class="form-label">Denumire</label>
                                                <input type="text" id="customername-field" name="cat_title" class="form-control" placeholder="Denumire" required />
                                            </div>
                                            <div class="mb-3">
                                                <label for="customername-field" class="form-label">Poza(Portret)</label>
                                                <input type="file" id="customername-field" name="cat_image" class="form-control" />
                                            ...
                                            <div class="mb-3">
                                                <label for="phone-field" class="form-label">Pozitie</label>
                                                <input type="text" id="phone-field" class="form-control" value="{{$categories->count()+1}}" placeholder="Enter Phone no." required />
                                            </div>
