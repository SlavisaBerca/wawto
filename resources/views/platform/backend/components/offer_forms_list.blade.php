                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title mb-0">Lista de formulare(Cereri de oferta)</h4>
                                    </div><!-- end card header -->
                                            ...
                                            <div class="table-responsive table-card mt-3 mb-1">
                                                <table class="table align-middle table-nowrap" id="customerTable">
                                                    ...
                                                    <tbody class="list form-check-all">
                                                        ...
                                                        @if(!$domain->requestform->has_part)
                                                        <tr>
                                                          ...
                                                          <td class="customer_name"><i class="fa fa-sort-amount-up"></i> {{$domain->position}}</span></td>
                                                            ...
                                                            <td>
                                                                <div class="d-flex gap-2">
                                                                    <div class="edit">
                                                                        <a class="btn btn-sm btn-success edit-item-btn" href="{{route('offer-form',$domain->id)}}"
                                                                       ><i class="fa fa-cogs"></i> Setari</a>
                                                                    </div>
