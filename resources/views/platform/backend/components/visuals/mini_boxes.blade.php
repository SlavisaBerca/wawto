                                                            ...
                                                            <td>
                                                                <div class="d-flex gap-2">
                                                                    <div class="edit">
                                                                        ...
                                                                        data-bs-toggle="modal" data-bs-target="#editModal{{$box->box_id}}">Edit</button>
                                                                    </div>
                                                                    <div class="remove">
                                                                        <button class="btn btn-sm btn-danger remove-item-btn" data-bs-toggle="modal" data-bs-target="#deleteRecordModal{{$box->box_id}}">Remove</button>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                                            ...
                                                                            <div class="hstack gap-2 justify-content-end">
                                                                                ...
                                                                                <button type="submit" class="btn btn-success" id="add-btn">Editare</button>
                                                                                            ...
                                                                                            <!--Edit modal Edns-->
                                                                                                                    ...
                                                                                                                    <!-- Modal -->
                                                                <div class="modal fade zoomIn" id="deleteRecordModal{{$box->box_id}}" tabindex="-1" aria-hidden="true">
                                                                    <div class="modal-dialog modal-dialog-centered">
                                                                        <div class="modal-content">
                        ...
                        <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <form action="{{route('add-minibox')}}" method="post">
                                        {{csrf_field()}}
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3" style="display:none;" id="page_type">
                                                <label for="date-field" class="form-label">Tip</label>
                                                <select name="page_type" id="pt" class="form-control">
                                                    <option value="" selected disabled>Alegeti Tip</option>
                                                    <option value="search">Pagina de cautare</option>
                                                    <option value="home">Pagina Home</option>
                                                    <option value="users">Pagina de utilizatori</option>
                                                    <option value="">Alaturi paginei</option>
...
@push('scripts')
  ...
  $(document).on('change','#pi',function(){
      ...
      if(value == ''){
          ...
          $('#pt').attr('required');
          $('#page_id').attr('style','display:none;')
      }
  });
