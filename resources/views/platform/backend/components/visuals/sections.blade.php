                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Sectiuni</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Organizare</a></li>
                                                ...
                                                <table class="table align-middle table-nowrap" id="customerTable">
                                                    <thead class="table-light">
                                                        <tr>
                                                            ...
                                                            <th class="sort" data-sort="phone">Pagina Statica</th>
                                                            <th class="sort" data-sort="phone">Fisierul</th>
                                                            <th class="sort" data-sort="action">Actiuni</th>
                                                            </tr>
                                                    </thead>
                                                    <tbody class="list form-check-all">
                                                        @foreach($sections as $section)
                                                        <tr class="row1" data-id="{{ $section->section_id }}">
                                                           
                                                            
                                                            <td class="customer_name"><i class="fa fa-sort-amount-up"></i> {{$section->position}}</td>
                                                            <td class="email">{{$section->page->menu->menu_title}}</td>

                                                             @if($section->page_type)
                                                            <td class="email">{{$section->page_type}}</td>
                                                            @else 
                                                            <td class="email">Dedicata {{$section->page->menu->menu_title}}</td>
                                                            @endif
                                                            <td class="email">{{$section->folder}}</td>
                                                           
                                                            <td>
                                                                <div class="d-flex gap-2">
                                                                    
                                                                    <div class="remove">
                                                                        <a class="btn btn-sm btn-danger remove-item-btn" href="{{route('delete-section',$section->section_id)}}">Sterge</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
