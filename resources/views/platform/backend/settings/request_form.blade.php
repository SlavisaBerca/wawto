                                        ...
                                        <div id="customerList">
                                            <div class="row g-4 mb-3">
                                                <div class="col-sm-auto">
                                                    ...
                                                    <button type="button" class="btn btn-warning add-btn" data-bs-toggle="modal" id="create-btn" data-bs-target="#showModalSetting"><i class="fa fa-cog"></i> Setari</button>
												   </div>
                                                </div>
                                                <div class="col-sm">
                                            ...
                                            <div class="table-responsive table-card mt-3 mb-1">
                                                <table class="table align-middle table-nowrap" id="customerTable">
                                                    ...
                                                    <tbody class="list form-check-all">
                                                        ...
                                                        <tr  class="row1" data-id="{{ $component->component_id }}">
                                                            ...
                                                            <td class="phone">
                                                            <button class="btn btn-sm btn-danger remove-item-btn" data-bs-toggle="modal" data-bs-target="#deleteRecordModal{{$component->component_id}}">Sterge</button>
                                                            </td>
                                                        </tr>


                                                          <!-- Modal -->
                        <div class="modal fade zoomIn" id="deleteRecordModal{{$component->component_id}}" tabindex="-1" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                            ...
                                            <a href="{{route('delete-component',$component->component_id)}}" class="btn w-sm btn-danger " id="delete-record">Da, Sunt sigur!</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <input type="hidden" name="form_id" value="{{$form->id}}">
                                            ...
                                            <div class="mb-3">
											  ...
											  <div class="mb-3">
                                                ...
                                                <label for="email-field" class="form-label"><input id="ml" type="checkbox" name="ml" value="1"> Seteaza lungime Obligatorie</label>
                                               
                                            </div>
											  <div class="mb-3 max" style="display:none;">
                                                
                                                <label for="email-field" class="form-label"> Seteaza lungime Obligatorie</label>
												<input type="text" name="length" value = "17" class="form-control">
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                            <button type="button" class="btn w-sm btn-light" data-bs-dismiss="modal">Inchide</button>
                                            <a href="{{route('destroy-components')}}" class="btn w-sm btn-danger " id="delete-record">Da, Sunt sigur!</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
