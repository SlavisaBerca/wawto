...
@section('content')
                            ...
                            <div class="product-default">
                                @if($supplier->profile_image)
                                    ...
                                    <a href="{{route('suppliers')}}">
                                        <img src="{{URL::to('platform/frontend/assets/images/customer_images/'.$supplier->personal_code.'/profile_images/'.$supplier->profile_image)}}" width="280" height="280" alt="product" style="width:100%;" class="rounded-circle mb-2">
                   ...
                   <i class="far fa-star"></i>
                    @endif
                                    ...
                                    <tr>
                                        <th>Vizualizare: </th>
                                        <th><button class="btn btn-gray btn-sm" style="width:100%;" data-toggle="modal" data-target="#view{{$supplier->id}}" id="view"><i class="fa fa-eye text-dark"></i></button> </th>
                                    </tr>
                                </table>
                                    <!-- End .price-box -->
                                          ...
                                          <div class="col-md-5">
                                              ...
                                              @endif
                                               ...
                                               <table class="table table-bordered mt-2">
                                                  ...
                                                  <tr>
                                                      <th>Bazat pe</th>
                                                      <th>{{$supplier->rating->count()}} Revizii</th>
                                                  </tr>
                                                   </tr>
