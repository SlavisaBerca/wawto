...
@section('content')
                    <div class="col-lg-9">
                        ...
                        <div class="sticky-wrapper"><nav class="toolbox sticky-header mt-2" data-sticky-options="{'mobile': true}">
                            <div class="toolbox-left">
                                ...
                                <form action="{{route('domain-suppliers',$domain->domain_url)}}" method="get" id="order-form">
                            ...
                            <!-- End .toolbox-left -->
                            <form action="{{route('domain-suppliers',$domain->domain_url)}}" method="get" id="limit-form">
                            <div class="toolbox-right">
                                ...
                                <div class="toolbox-item layout-modes">
                                    ...
                                    <a href="{{route('domain-suppliers',$domain->domain_url)}}" class="layout-btn btn-list" title="List">
                            ...
                            <div class="product-default">
                                @if($supplier->user->profile_image)
                                    ...
                                    <a href="{{route('domain-suppliers',$domain->domain_url)}}">
                                        <img src="{{URL::to('platform/frontend/assets/images/customer_images/'.$supplier->user->personal_code.'/profile_images/'.$supplier->profile_image)}}" width="280" height="280" alt="product" style="width:100%;" class="ml-5">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <th>Judet:</th>
                                        <th>{{$supplier->user->region->region_name}}</th>
                                    </tr>
                                    <tr>
                                        <th>Oras: </th>
                                        <th>{{$supplier->user->city->city_name}}</th>
                                    </tr>
                                    <tr>
                                        <th>Reiting</th>
                                        <th>
                                            <?php 
                     $start_rate=$supplier->user->rating->sum('rating');
                     $devide=$supplier->user->rating()->count();
                     if($devide > 0){
                   ...
                   <i class="far fa-star"></i>
                    @endif
                                    ...
                                    <tr>
                                        <th>Bazat pe:</th>
                                        <th>{{$supplier->user->rating->count()}} Revs.</th>
                                    </tr>
                                    <tr>
                                        <th>Vizualizare: </th>
                                        <th><button class="btn btn-gray btn-sm" style="width:100%;"id="view" data-toggle="modal" data-target="#view{{$supplier->user->id}}"><i class="fa fa-eye text-dark"></i></button> </th>
                                    </tr>
                                </table>
                                    <!-- End .price-box -->
                        ...
                        <!-- End .col-sm-4 -->
                         ...
                         <!-- Modal -->
                         <div class="modal fade zoomIn" id="view{{$supplier->user->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-body" style="overflow:hidden;">
                                  <div class="row">
                                      <div class="col-md-5">
                                          ...
                                          <img src="{{URL::to('platform/frontend/assets/images/customer_images/'.$supplier->user->personal_code.'/profile_images/'.$supplier->profile_image)}}" alt="" class="rounded-circle">
                                          ...
                                          @endif
                                           ...
                                           <table class="table table-bordered mt-2">
                                              ...
                                              <tr>
                                                  <th>Bazat pe</th>
                                                  <th>{{$supplier->user->rating->count()}} Revizii</th>
                                              </tr>
                                               </tr>
                                      ...
                                      <div class="card">
                                          <div class="card-body">
                                              <table class="table table-bordered">
                                                  ...
                                                  <tr>
                                                      <th>Cui:</th>
                                                      <th>{{$supplier->user->cui}}</th>
                                                  </tr>

                                                  <tr>
                                                      <th>Nr. Inregistrari (J)</th>
                                                      <th>{{$supplier->user->registration_number}}</th>
                                                  </tr>

                                                  <tr>
                                                      <th>IBAN:</th>
                                                      <th>{{$supplier->user->iban}}</th>
                                                  </tr>

                                                  <tr>
                                                      <th>Banca: </th>
                                                      <th>{{$supplier->user->bank}}</th>
                                                  </tr>
                        ...
                        <nav class="toolbox toolbox-pagination">
                            <form action="{{route('domain-suppliers',$domain->domain_url)}}" method="get" id="limit-form-down">
                            <div class="toolbox-item toolbox-show">
                                <label>Afisez:</label>
