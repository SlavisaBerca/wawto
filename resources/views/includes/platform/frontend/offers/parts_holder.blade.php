       ...
       <div class="product-single-container product-single-default">
           <div class="row">
                <div class="col-lg-6 col-md-6 product-single-gallery">
                    <div class="product-slider-container">
                        ...
                        <div class="product-single-carousel owl-carousel owl-theme show-nav-hover">
                            ...
                            @if($offer->image)
                            <div class="owl-dot">
                                <img class="product-single-image" src="{{URL::to('platform/frontend/assets/images/customer_images/'.$request->client->personal_code.'/requests/'.$request->request_number.'/offers/'.$offer->number.'/'.$offer->image)}}" data-zoom-image="{{URL::to('platform/frontend/assets/images/customer_images/'.$request->client->personal_code.'/requests/'.$request->request_number.'/offers/'.$offer->number.'/'.$offer->image)}}" width="468" height="468" alt="product" />
                            </div>
                            ...
                            @if($offer->image1)
                            <div class="owl-dot">
                                <img class="product-single-image" src="{{URL::to('platform/frontend/assets/images/customer_images/'.$request->client->personal_code.'/requests/'.$request->request_number.'/offers/'.$offer->number.'/'.$offer->image1)}}" data-zoom-image="{{URL::to('platform/frontend/assets/images/customer_images/'.$request->client->personal_code.'/requests/'.$request->request_number.'/offers/'.$offer->number.'/'.$offer->image1)}}" width="468" height="468" alt="product" />
                            </div>
                ...
                <div class="card">
					...
					<?php $part = \App\Models\Platform\Part::where('part_id',$offer->part_id)->first();?>
                    <div class="card-body">
